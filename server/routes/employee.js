 ...
 * @example
 * localhost:3000/api/employees/1007/tasks - 200: Success
 * localhost:3000/api/employees/1007/tasks - 400: Bad Request
 * localhost:3000/api/employees/1007/tasks - 404: Not Found
 * localhost:3000/api/employees/1007/tasks - 500: Internal Server Error
 */
router.get("/:empId/tasks", (req, res, next) => {
  try {
    console.log("findAllTasks API");
